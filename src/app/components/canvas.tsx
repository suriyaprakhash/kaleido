...
function Canvas({ actualJsonData, actuatorType, parentCallback }: any) {
  ...
  return (
    <section>
      ...
      <section className="border-4 border-red-800 grid grid-cols-12 p-2">
        <div className="col-span-10 border-4 border-red-700 p-2">
          ...
          <button onClick={onGraphSelect}
            ...
            <span>
              Select visulaization to switch
            </span>
            ...
            <div
              ...
              <span id="force" className="flex flex-row gap-2 items-center hover:bg-zinc-100 p-2 rounded-lg">
                ...
                <p id="force">Force directed graph</p>
              </span>
